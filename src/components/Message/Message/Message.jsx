...
export const Message = ({ content }) => {
	if (content) {
		...
		return (
			...
			>
				<p className={classNames("message__name", {
					'message__name--support': role === SUPPORT,
					'message__name--user': role === USER
				})}>
					{name}
				</p>

				<div className={classNames('person__avatar message__avatar', {
					'message__avatar--support': role === SUPPORT,
				...
				{message.map((msg) => {
					...
					return (
						<p key={id} className={classNames('message__text', {
							'message__text--support': role === SUPPORT,
							'message__text--user': role === USER
						})}>{text}</p>
					)})}
				...
				{type === TYPING_MESSAGE &&
					<div className={classNames("message__text message__dots-box", {
						'message__text--support': role === SUPPORT,
						'message__text--user': role === USER
					})}>
